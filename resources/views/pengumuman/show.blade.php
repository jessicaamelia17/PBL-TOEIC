...
@section('content')
    <div class="container mx-auto min-h-screen py-12 px-4 md:px-6 lg:px-8 pb-32">
        ...
        <div class="bg-white p-8 rounded-lg shadow">
            ...
            <p class="text-gray-600 mb-2"><strong>@lang('users.date_post'):</strong>
                {{ \Carbon\Carbon::parse($pengumuman->Tanggal_Pengumuman)->translatedFormat('d M Y') }}</p>
            ...
            @if ($pengumuman->file_pengumuman)
                ...
                <div class="mb-4">
                    <strong class="block mb-1 text-gray-800">@lang('users.attachment'):</strong>
                ...
                @elseif (strtolower($extension) === 'pdf')
                    <iframe src="{{ asset($filePath) }}" class="w-full h-[1000px] mt-4 border rounded"
